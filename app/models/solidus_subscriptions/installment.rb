...
module SolidusSubscriptions
  class Installment < ApplicationRecord
    ...
    def maximum_reprocessing_time_reached?
      ...
      return false unless subscription.installments.fulfilled

      last_successful_installment_fulfillment_date = subscription.installments.fulfilled.last.details.last.created_at
      last_successful_installment_fulfillment_date + SolidusSubscriptions.configuration.maximum_reprocessing_time < Time.zone.now
    end
